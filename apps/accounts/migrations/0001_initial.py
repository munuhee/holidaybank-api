    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='Administrator', max_length=120)),
                ('legacy_role', models.CharField(choices=[('admin', 'Admin'), ('editor', 'Editor')], default='editor', max_length=10)),
                ('is_active', models.BooleanField(default=True)),
                ('is_staff', models.BooleanField(default=False)),
                ('is_sample', models.BooleanField(default=False, help_text='Demo staff account created by the seed; cannot sign in.')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_label', models.CharField(blank=True, max_length=254, null=True)),
